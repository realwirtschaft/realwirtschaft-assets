...
(function () {
  ...
  const styles = `
  .n8n-chat-widget {
            --chat--color-primary: #121212;
            --chat--color-secondary: #121212;
            --chat--color-background: #f5f5f5;
            --chat--color-font: #121212;
  ...
  const defaultConfig = {
    ...
    branding: {
      ...
      poweredBy: {
        text: "Powered by realwirtschaft",
        link: "realwirtschaft-agency.com",
      },
    },
    style: {
      primaryColor: "#121212",
  ...
  const chatInterfaceHTML = `
        <div class="chat-interface">
            ...
            <div class="chat-input">
                <textarea placeholder="Schreibe deine Nachricht hier..." rows="1"></textarea>
